    ...
    <div class="page-content page-categories">
      <section class="store-trend-categories">
        <div class="container">
          ...
          <div class="row">
            {{-- $incrementCategory digunakan untuk me loopong data aos/animasi --}}
            @php
              $incrementCategory = 0
            @endphp
              ...
              <a class="component-products d-block" href="{{ route('detail', $product->slug) }}">
                <div class="products-thumbnail">
                  <div
                    ...
                    style="
                    {{-- membuat kondisi apabila produk tidak ada gambar tidak terjadi error --}}
